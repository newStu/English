...
| impossible     | adj.不可能的  | unfortunately | 不幸地               |
| just           | adv.仅仅,正好 | only          | adv.仅,只;adj.唯一的 |
| dead           | 死亡的        | kill          | 杀死                 |
...
I was just waiting for Peter at home. I was worried, so I called him. (just:正在)
