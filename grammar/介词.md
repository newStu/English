...
- **take + 修饰词 + 交通工具** : 具体的某一次乘坐行为
  ...
  **take a bus / car / ship / train / taxi / boat / motorcycle / subway ...**
  ...
  He takes the train to work every day.（他每天乘火车去上班。）

- **in + 修饰词 + 交通工具** (小车) : 在较小的交通工具内部

  **in a car / taxi / motorcycle / boat / scooter**

- **on + 修饰词 + 交通工具** (大车) : 在较大的交通工具上

  **on a bus / train / subway / plane / ship / skateboard / roller skates ...**
...
- **里面上面 in 和 on , at 在某点上**

  **in + 大地点(>= 区)** ： in Beijing 、in the US <br/>
  **at + 小地点(小于区)** ： at school、at the airport、at No.10 Downing Street <br/>
  **on 用于接触面** ：on the table、on the floor <br/>
...
- **区域介词：in 、on 、to**
  ...
  **to 不相邻不接壤**
  ...
  Japan is <u>to</u> the east of China. （日本在中国的东边。）
...
- **穿过 through、横过 across、越过 over**
  ...
  She walked across the street.She walked across the street.（她走过街道。）<br/>
...
on the tree ：长在数上面的 ( O 像果子 ，长在书上 )<br/>
...
- 伴随 : I usually go shopping with my friends.
- 工具或手段 : He cut the apple with a knife.
